export default function DeleteRestaurantButton({
  ...
  return (
    <button
      className="flex px-3 py-2 bg-red-500 rounded justify-between items-center 
      text-center text-white text-base font-medium font-['Helvetica Neue'] 
      leading-normal space-x-2
    hover:bg-red-600"
      onClick={onClick}
    >
      <svg
